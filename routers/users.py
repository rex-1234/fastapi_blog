...
from fastapi_blog.image_utils import delete_profile_image, process_profile_image
from fastapi_blog.schemas import PostResponse, UserCreate, UserPublic, UserPrivate, UserUpdate, Token
...
@router.delete("/{user_id}/profile_image", response_model=UserPrivate)
