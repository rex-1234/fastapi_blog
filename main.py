...
from fastapi_blog.schemas import PostCreate, PostUpdate, PostResponse, UserCreate, UserUpdate, UserResposne
...
@app.post("/api/users", response_model=UserResposne, status_code=status.HTTP_201_CREATED)
...
@app.get("/api/users/{user_id}", response_model=UserResposne)
...
@app.patch("/api/users/{user_id}", response_model=UserResposne)
